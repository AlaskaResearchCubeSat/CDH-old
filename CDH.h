...
enum{CMD_PARSE_PRINT_STR=1<<0,CMD_PARSE_SPI_CLEAR=1<<2,CMD_PARSE_GET_STAT=1<<4,CMD_PARSE_SEND_STAT=1<<5};

#define CMD_PARSE_ALL (CMD_PARSE_PRINT_STR|CMD_PARSE_SPI_CLEAR|CMD_PARSE_GET_STAT|CMD_PARSE_SEND_STAT)
